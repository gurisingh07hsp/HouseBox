        ...
        <>
            <Layout headerStyle={3} footerStyle={3}>
                <div>
                    ...
                    <div className="properties-details3-area sp1">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="images-area-details">
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <Swiper {...swiperOptions2} className="img2-carousel owl-carousel mb-4">
                                                    <SwiperSlide>
                    ...
                    <div className="propoerties-boxes-section">
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <Swiper {...swiperOptions1} className="single-slider-area owl-carousel">
