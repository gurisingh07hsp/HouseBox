        ...
        <>
            <div>
                <div className="footer-top-section">
                    <img src="/assets/img/elements/elements5.png" alt="housebox" className="elements5" />
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="footer-top-area">
                                    ...
                                    <div className="pera">
                                        <p>
                                            Your trusted partner for buying, selling, and renting <br className="d-md-block d-none" />
                            ...
                            <div className="col-lg col-md-6 col-12">
                                <div className="footer-content">
                                    ...
                                    <ul className="contact">
                                        <li>
                                            <Link style={{display: 'flex', alignItems: 'center'}} href="tel:#+11234567890">
                                        ...
                                        <li>
                                            <Link style={{display: 'flex', alignItems: 'center'}} href="mailto:houseboxesate.com">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="copyright">
                                    <p>©Copyright {new Date().getFullYear()} - Housebox. All Right Reserved</p>
                                    <ul>
                                        <li>
