...
export default function Properties3() {
    return (
        <>
            <div className="properties3-section-area sp2" style={{ backgroundImage: "url(assets/img/all-images/bg/bg3.png)", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
    ...
    <ul className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6">
      ...
      <li className="py-2">
        <button
          className="w-full flex flex-col items-center justify-center gap-3 px-4 py-6 hover:bg-blue-50 transition-all duration-300 group"
        >
        ...
        >
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M12.5812 2.68627C12.2335 2.43791 11.7664 2.43791 11.4187 2.68627L1.9187 9.47198L3.08118 11.0994L11.9999 4.7289L20.9187 11.0994L22.0812 9.47198L12.5812 2.68627Z"></path>
            </svg>
          </div>
        ...
        >
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M21 19H23V21H1V19H3V4C3 3.44772 3.44772 3 4 3H14C14.5523 3 15 3.44772 15 4V19H19V11H17V9H20Z"></path>
            </svg>
          </div>
        ...
        >
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M12.6727 1.61162 20.7999 9H17.8267L12 3.70302 6 9.15757V19.0001H11V21.0001H5Z"></path>
            </svg>
          </div>
        ...
        >
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M22 21H2V19H3V4C3 3.44772 3.44772 3 4 3H18C18.5523 3 19 3.44772 19 4V9H21V19H22V21Z"></path>
            </svg>
          </div>
        ...
        >
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M3 19V5.70046C3 5.27995 3.26307 4.90437 3.65826 4.76067L13.3291 1.24398C13.5886 1.14961 13.8755 1.28349 13.9699 1.54301Z"></path>
            </svg>
          </div>
                                        ...
                                        <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex={0}>
                                            <div className="row">
                                                            ...
                                                            <div className="btn-area">
                                                                ...
                                                                <div style={{display: 'flex', alignItems: 'center', gap: '5px'}} className="love-share">
                                                                    <Link href="#" className="heart flex justify-center items-center">
                                                                        <img src="/assets/img/icons/heart3.svg" alt="housebox" className="heart1" /> <img src="/assets/img/icons/heart4.svg" alt="housebox" className="heart2" />
                                                                    </Link>
                                                                    <Link href="#" className="share" style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                                                ...
                                                <div className="col-lg-4 col-md-6">
                                                    <div className="property-single-boxarea">
                                                        <div className="img1 image-anime">
                                                            <img src="/assets/img/all-images/properties/property-img14.png" alt="housebox" />
                                                        </div>
                                                        <ul className="category-list">
                                                            <li>
                                                                <Link href="/property-details-v1">Featured</Link>
                                                    ...
                                                    <div className="property-single-boxarea">
                                                        <div className="img1 image-anime">
                                                            <Swiper {...swiperFade} className="swiper swiper-fade">
                                                                <div className="swiper-wrapper">
                                                                    <SwiperSlide>
                                                                        <img src="/assets/img/all-images/properties/property-img15.png" alt="housebox" />
                                                                    </SwiperSlide>
                                                                    <SwiperSlide>
                                                                        <img src="/assets/img/all-images/properties/property-img14.png" alt="housebox" />
                                                                    </SwiperSlide>
                                                                    <SwiperSlide>
                                                                        <img src="/assets/img/all-images/properties/property-img13.png" alt="housebox" />
                                                                    </SwiperSlide>
                                                                </div>
                                                                <div className="swiper-pagination" />
                                                            </Swiper>
                                                ...
                                                <div className="col-lg-4 col-md-6">
                                                    <div className="property-single-boxarea">
                                                        <div className="img1 image-anime">
                                                            <img src="/assets/img/all-images/properties/property-img16.png" alt="housebox" />
                                                        </div>
                                                        <ul className="category-list">
                                                            <li>
                                                                <Link href="/property-details-v1">Featured</Link>
                                                    ...
                                                    <div className="property-single-boxarea">
                                                        <div className="img1 image-anime">
                                                            <Swiper {...swiperFade} className="swiper swiper-fade">
                                                                <div className="swiper-wrapper">
                                                                    <SwiperSlide>
                                                                        <img src="/assets/img/all-images/properties/property-img17.png" alt="housebox" />
                                                                    </SwiperSlide>
                                                                    <SwiperSlide>
                                                                        <img src="/assets/img/all-images/properties/property-img2.png" alt="housebox" />
                                                                    </SwiperSlide>
                                                ...
                                                <div className="col-lg-4 col-md-6">
                                                    <div className="property-single-boxarea">
                                                        <div className="img1 image-anime">
                                                            <img src="/assets/img/all-images/properties/property-img18.png" alt="housebox" />
                                                        </div>
                                                        <ul className="category-list">
                                                            <li>
                                                                <Link href="/property-details-v1">Featured</Link>
